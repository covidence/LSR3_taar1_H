...
forest(`meta_comp_taar1_vs_placebo_3-13 weeks_depression`, 
                 rightcols = c("effect", "ci"), 
                 rightlabs = c("SMD", "95%-CI"),  xlim=c(-0.5,0.5),
...
forest(`meta_comp_taar1_vs_placebo_3-13 weeks_response`, 
                 rightcols = c("effect", "ci"), 
                 rightlabs = c("OR", "95%-CI"),  xlim=c(0.2,5),
...
```{r echo=F, fig.fullwidth=T, fig.width=11, fig.height=4}
forest(`meta_comp_taar1_vs_placebo_1 day-2 weeks_anticholinertgic_symptom`, 
       leftcols = c("studlab",  "effect", "ci"),           
       rightcols = FALSE,
            #      xlim=c(0.2,5),
                 label.e = unique(`meta_comp_taar1_vs_placebo_1 day-2 weeks_anticholinertgic_symptom`$data$treat1_new), 
                 subgroup.hetstat = TRUE, overall.hetstat =TRUE, test.subgroup.random = FALSE,test.subgroup.fixed = FALSE,
...
```{r echo=F, fig.fullwidth=T, fig.width=11, fig.height=4}
forest(`meta_comp_taar1_vs_antipsychotic_1 day-2 weeks_anticholinertgic_symptom`, 
                 rightcols = c("effect", "ci"), 
                 rightlabs = c("OR", "95%-CI"),  
      # xlim=c(0.2,5),
                 label.e = unique(`meta_comp_taar1_vs_antipsychotic_1 day-2 weeks_anticholinertgic_symptom`$data$treat1_new), 
     #  label.c=unique(`meta_comp_taar1_vs_antipsychotic_3-13 weeks_dropout_any`$data$treat2_new),
                 subgroup.hetstat = TRUE, overall.hetstat =FALSE, test.subgroup.random = FALSE,test.subgroup.fixed = FALSE,
                 overall = FALSE, prediction.subgroup = FALSE,
                 subgroup = TRUE, fixed=TRUE,
