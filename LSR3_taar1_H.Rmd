...
```{r setup,message=F,echo=F,include=F, cache=TRUE}
### libraries
library(meta)
library(tidyverse)
library(tibble)
...
```{r echo=F, fig.fullwidth=T, fig.width=12, fig.height=8, cache=TRUE}
...
```{r echo =F, fig.fullwidth=T, fig.width=7.2, fig.height=6, cache=TRUE}
...
```{r echo=F, fig.fullwidth=T, fig.width=12, fig.height=4, cache=TRUE}
forest(meta_comp_overall_sch, 
       ...
       label.c=unique(meta_comp_overall_sch$data$treat2_new),
                 ...
                 label.left = "Placebo XXXXX better", label.right="TAAR1 better")
```
...
forest(meta_comp_overall_pdp, 
       ...
       label.c=unique(meta_comp_overall_pdp$data$treat2_new),
                 ...
                 subgroup = FALSE, fixed=TRUE,
                 label.left = "Placebo XXXX better", label.right="TAAR1 better")
```
...
```{r echo=F, fig.fullwidth=T, fig.width=11, fig.height=4, cache=TRUE}
...
```{r echo=F, fig.fullwidth=T, fig.width=10, fig.height=5, warning=FALSE, cache=TRUE}
...
```{r echo=F, fig.fullwidth=T, fig.width=10, fig.height=5, cache=TRUE}
...
```{r echo=F, fig.fullwidth=T, fig.width=11, fig.height=5, cache=TRUE}
...
```{r echo=F, fig.fullwidth=T, fig.width=11, fig.height=8, warning=FALSE, cache=TRUE}
...
```{r echo=F, fig.fullwidth=T, fig.width=11, fig.height=4, warning=FALSE, cache=TRUE}
