...
author: "Spyridon Siafis <span style='font-size: 15px'></style>"
...
**Acute psychosis**: 
There were *five trials* that provived data for the timepoint of 3-13 weeks: 
1) One study on ralmitaront, i.e., NCT04512066 examining the comparisons of ralmitaront vs. placebo or risperidone in adults with schizophrenia or schizoaffective disorder.
2) Four studies on ulotaront, i.e., Isaacson 2023 in adults with Parkinson disease psychosis, and Koblan 2020, NCT04072354 and NCT04092686 in adults with schizophrenia. 
*Unavailable trials*: 
1) The study NCT04072354 (ulotaront vs. placebo) consisted of adolescent and adult parts, but data for the former were not found and the status is unclear.
2) One study (NCT04825860) examining ulotaront vs. placebo in adults with schizophrenia is currently ongoing.

**Clinically stable patients with psychosis**: 
There were data from *one trial* that provided data for the timepoint 1 day - 2 weeks: Tsukada 2023 that was a single dose crossover trial examining mainly the effects of ulotaront vs. placebo or moxifloxacin (not relevant for this analysis) on QTc interval prolongation in stable patients with schizophrenia.
...
```{r echo=F, fig.fullwidth=T, fig.width=11, fig.height=12}
...
```{r echo=F, fig.fullwidth=T, fig.width=11, fig.height=4}
forest_presentation(`meta_comp_taar1_vs_antipsychotic_3-13 weeks_anxiety`, "safety")
```
...
ggplot(data=data_doses, aes(x=dose,
  ...
  theme_bw()
```
*It should be noted that Koblan 2020 was a two-arm flexible dose study, and its effect size is placed in the middle of the range of the administered dose (50mg/d to 75mg/d), yet the median or mean dose in the trial could be different and was not reported.
**The study of Isaacson 2023 was not presented here, as it was included participants with Parkinson disease psychosis.
...
```
✓: A study result is available for inclusion in the meta-analysis.; ~:No study result is available for inclusion in the meta-analysis, for a reason unrelated to the P value, magnitude or direction of the result.; ?: Unclear whether an eligible study result was generated. 
*NCT04072354 included two parts, i.e., adults (sample size 435) and adolescents (sample size unclear but probably 28; planned 90). It should be noted that all of the other studies included adult populations.
**NCT04825860 is an ongoing trial. 
...
| TAAR1 agonist. vs placebo in adults with Parkinson disease psychosis |  n=1, k=37, SMD= -0.28, 95%CI: -0.95, 0.38 |  100% of the studies had an overall high risk of bias (due to missing outcome data, unclear direction and impact on the findings) | Low risk of reporting bias  | No clear indication of indirectness  in terms of population, interventions and outcomes | No clear indication of other biases                         |
| TAAR1 agonist. vs placebo in adults with schizophrenia spectrum disorder | n=4, k=1296, SMD=0.14, 95%CI: -0.17, 0.46, tau2=0.024  |   50% of the studies had high risk of bias, 50% of the studies had some concerns (mainly due to missing outcome data, unclear direction and impact on the findings) |  Low risk of reporting bias  |  50% of the studies had potential concern of indirectness due to being conducting during the COVID-19 pandemic (potentially associated with factors that could have diluted effect sizes) | No clear dose-effects. No clear indication of other biases  | 
|TAAR1 agonist. vs other antipsychotics in adults with schizophrenia spectrum disorder | n=1, k=156, SMD=-0.53, 95%CI: -0.86, -0.20 |   100% of the studies had some concerns (due to missing outcome data, unclear direction and impact on the findings) |  Low risk of reporting bias  | Data available only for ralmitaront (no data for ulotaront) and risperidone (no data for other antipsychotics). No other clear indication of indirectness in terms of population and outcomes  | No clear indication of other biases | 
...
TAAR1 agonists  may have little to no effect compared to placebo on overall symptoms in acutely ill adults with schizophrenia spectrum disorder (SMD=0.14, 95%CI: -0.17, 0.46) but the evidence is very uncertain. Specifically, the confidence in the evidence was *very low* due to major concerns in imprecision (95%CI crossed beyond SMD -0.1 and 0.1), some concerns in the risk of bias (studies with some concerns or high risk of bias), some concerns in heterogeneity (although could not be well estimated due to the small number of studies) and some concerns in indirectness (50% of the studies were conduced during COVID-19 pandemic).
